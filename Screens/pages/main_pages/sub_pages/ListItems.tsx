...
return(<>
    ...
    <Text style={[{flex:1,padding:10,fontWeight:"bold",color:"black",opacity:0.8,borderRadius:3,textAlign:"center",backgroundColor:"white"}]}>날짜< Text style={{fontWeight:"300"}}>  :  {data.date}</Text></Text>
    <Text style={[{flex:1,padding:10,fontWeight:"bold",color:"black",opacity:0.8,borderRadius:3,textAlign:"center",backgroundColor:"white"}]}>차량 번호< Text style={{fontWeight:"300"}}>  :  {data.carNum}</Text></Text>
    <Text style={[{flex:1,padding:10,fontWeight:"bold",color:"black",opacity:0.8,borderRadius:3,textAlign:"center",backgroundColor:"white"}]}>분류< Text style={{fontWeight:"300"}}>  :  {data.division}</Text></Text>
...
<Image style={{flex:2,resizeMode:"stretch",borderRadius:15}} source={{uri:data.image}}/>
